...
export const HeroSection: React.FC = () => {
  ...
  const lightningHue = 220; // Fixed hue value
  const handleSearch = () => {
    ...
    <div className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="relative z-30 flex flex-col items-center text-center max-w-5xl mx-auto pt-24"
        >
          {/* Main Slogan */}
          <motion.h1
            variants={itemVariants}
            className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight px-4"
          >
            SKIP THE BUILD. LAUNCH FASTER WITH PREMIUM WEB APPLICATIONS
          </motion.h1>

          {/* Subtitle */}
          <motion.p
            variants={itemVariants}
            className="text-base md:text-lg text-white/70 mb-8 max-w-2xl px-4"
          >
            Get production-ready web applications built with cutting-edge technology. 
            Save months of development time and launch your business faster.
          </motion.p>
      ...
      >
        ...
        <motion.button
          ...
          className="px-8 py-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-full font-semibold hover:bg-white/20 transition-all"
        >
          View Products
        </motion.button>
      </motion.div>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm md:text-base text-white/60">Products</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-2">100+</div>
              <div className="text-sm md:text-base text-white/60">Happy Clients</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-2">99%</div>
              <div className="text-sm md:text-base text-white/60">Satisfaction</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
